...
public class RedisTestService {
    ...
    public void setSerializeObjectTest(){
        ...
        WorkOrderEntity wh = new WorkOrderEntity();
        wh.setBusinessNo("ABCD阿卡卡姐");
    ...
    public void getSerializeObjectTest(){
        ...
        WorkOrderEntity wh = (WorkOrderEntity) SerializeUtil.unserialize(jedis.get(key.getBytes()));

        System.out.println(wh.getBusinessNo());
    }
}
